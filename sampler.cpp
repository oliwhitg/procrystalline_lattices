...
void Sampler::setProcrystal(string latType, int cnd, bool pat, VecF<int> patR, VecF<int> patL, int latDim, float fracH, float fracordH, float fracL, float fracordL, float fracLlin) {
...
void Sampler::setMonteCarlo(int seed, double temp, int samples, int mcsw) {
...
void Sampler::sample(Logfile &logfile) {
    ...
    procrystal.initialise(latticeType,nodeCnd,latticeDim,pattern, fractionH ,fractionorderedH, fractionL,fractionorderedL, fractionLlinear, patternR,patternL,outputPrefix,false,false,writeEnvs);
...
//    maxIterations=10000;
    ...
    for(;;){
        ...
        procrystal.initialise(latticeType,nodeCnd,latticeDim,pattern, fractionH ,fractionorderedH, fractionL,fractionorderedL, fractionLlinear,patternR,patternL,outputPrefix,true,false,writeEnvs);
    }
...
void Sampler::bruteForce(Logfile &logfile) {
    ...
    //Initialise procrystalline lattice
    Lattice procrystal(randomSeed);
    procrystal.initialise(latticeType,nodeCnd,latticeDim,pattern,fractionH ,fractionorderedH, fractionL,fractionorderedL, fractionLlinear, patternR,patternL,outputPrefix,false,true,writeEnvs);
    int numNodes=procrystal.getNumNodes();
    cout<<numNodes<<endl;
    ...
    do {
        ...
        if(accept){
            ...
            procrystal.initialise(latticeType,nodeCnd,latticeDim,pattern,fractionH ,fractionorderedH, fractionL,fractionorderedL, fractionLlinear, patternR,patternL,outputPrefix,true,true,writeEnvs);
            ...
            procrystal.initialise(latticeType,nodeCnd,latticeDim,pattern,fractionH ,fractionorderedH, fractionL,fractionorderedL, fractionLlinear, patternR,patternL,outputPrefix,true,writeEnvs);
            ++acceptCount;
        }
        ++bfCount;

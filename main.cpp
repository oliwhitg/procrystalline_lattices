...
int main() {
    ...
    logfile.write("Fraction:",fractionH);
    getline(inputFile,line);
    istringstream(line)>>fractionorderedH;
    logfile.write("Fraction:",fractionorderedH);
    getline(inputFile,line);
    ...
    logfile.write("Fraction:",fractionLlinear);
    ...
    //Initialise sampler
    Sampler sampler;
    sampler.setProcrystal(latticeType,nodeCnd,linkPattern,patternR,patternL,latticeDim, fractionH, fractionorderedH, fractionL, fractionorderedL, fractionLlinear);
    sampler.setMonteCarlo(randomSeed,temperature,samples, mcswitch);

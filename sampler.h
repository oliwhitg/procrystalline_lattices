...
public:
    ...
    Sampler();
    void setProcrystal(string latType, int cnd, bool pat, VecF<int> patR, VecF<int> patL, int latDim, float fracH, float fracordH, float fracL, float fracordL, float fracLlin);
    void setMonteCarlo(int seed, double temp, int samples, int mcsw);

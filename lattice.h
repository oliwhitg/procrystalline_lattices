...
public:
    ...
    //Member functions
    void initialise(string latType, int cnd, int latDim, bool pat, float fracH, float fracordH, float fracL, float fracordL, float fracLlin, VecF<int> patR, VecF<int> patL, string prefix, bool restart=false, bool crystal=false, bool envs=false);
